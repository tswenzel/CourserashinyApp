...
testData1$date <- format(testData1$date,'%Y-%m-%d')
testData1$MONTHDATE = as.Date(paste(paste0('20',str_sub(strftime(testData1$date,'%y')), start= -2),strftime(testData1$date,'%m'),'01',sep='-'))
testData1$MONTHDATE <- format(testData1$MONTHDATE,'%Y-%m-%d')
